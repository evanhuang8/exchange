...
urlpatterns = patterns('',
	...
	url(r'^individualRegister$', 'exchange.controllers.IndexController.individualRegister', name = 'exchange-individualRegister'),
	...
	url(r'^check$', 'exchange.controllers.PostController.check', name = 'exchange-check'),
